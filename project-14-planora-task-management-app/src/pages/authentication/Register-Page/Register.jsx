...
import createUserWithEmail from "../../../firebase/auth/firebaseCreateUser";
...
function SignUp() {
    ...
    function onsubmit(data) {
        ...
        setTimeout(async () => {
            ...
            await createUserWithEmail(userData, data.email, data.password);
        ...
        setTimeout(() => {
            ...
            setLoading(false);
            toast.success("user created successfully", { id: "login" });
        }, 1600);
    }
